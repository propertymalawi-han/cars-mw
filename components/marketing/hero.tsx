    ...
    <section className="relative pt-16">
      <div className="mx-auto w-full max-w-site px-6">
        <div className="grid items-center gap-12 lg:grid-cols-[1fr_0.85fr]">
          <div>
            <h1 className="max-w-[15ch] text-4xl font-bold leading-[1.12] tracking-tight sm:text-5xl">
      ...
      <div className="mt-11 border-t">
        <div className="mx-auto flex w-full max-w-site flex-col gap-3.5 px-6 py-[22px] sm:flex-row sm:items-stretch">
          {[
            {
...
function TrustItem({
  ...
  return (
    <div
      className={
        divided
          ? "flex flex-1 items-center gap-3 sm:border-l sm:px-5"
          : "flex flex-1 items-center gap-3 sm:px-5"
      }
    >
      {icon}
      <div>
